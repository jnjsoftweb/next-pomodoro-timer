  ...
  return (
    <div className="relative w-64 h-64">
      ...
      <div className="absolute bottom-16 left-0 right-0 flex justify-between px-14">
        <button 
          onClick={(e) => handleButtonClick('pomodoro', e)}
          style={getButtonStyle('pomodoro')}
        >
          P
        </button>
        <button 
          onClick={(e) => handleButtonClick('rest', e)}
          style={getButtonStyle('rest')}
        >
          R
        </button>
        <button 
          onClick={(e) => handleButtonClick('long', e)}
          style={getButtonStyle('long')}
        >
          L
        </button>
      </div>
